...
import com.mydrakortv.beta.adapter.SubtitleListAdapter;
...
public class PlayerActivity extends Activity {
    ...
    private static final String CLASS_NAME = "com.mydrakortv.beta.ui.activity.PlayerActivity";
    ...
    private void setSelectedSubtitle(MediaSource mediaSource, String url) {
        ...
        if (url != null) {
            ...
            if(videoType.equals("hls")) {
                dataSourceFactory = new DefaultDataSourceFactory(PlayerActivity.this,"(Linux; Android 5.0 .2)ExoPlayerLib", new DefaultBandwidthMeter());
            }else{
...
/*         else if (type.equals("youtube")) {
    ...
    private MediaSource mediaSource(Uri uri, Context context) {
        return new ExtractorMediaSource.Factory(
                new DefaultHttpDataSourceFactory("MydrakorTv")).
    ...
    private void extractYoutubeUrl(String url, final Context context, final int tag) {
        new YouTubeExtractor(context) {
            ...
            public void onExtractionComplete(SparseArray<YtFile> ytFiles, VideoMeta vMeta) {
                Log.e(TAG, "onExtractionComplete: "+ytFiles.get(18).getUrl());
                if (ytFiles != null) {
                    int itag = tag;
                    ...
                    try {
                        Log.e(TAG, "onExtractionComplete: "+downloadUrl);
    ...
    private MediaSource hlsMediaSource(Uri uri, Context context) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(context,"(Linux;Android 5.0.2) ExoPlayerLib", bandwidthMeter);
