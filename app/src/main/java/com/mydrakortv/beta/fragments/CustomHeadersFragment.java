...
import com.mydrakortv.beta.ui.IconHeaderItem;
import com.mydrakortv.beta.ui.activity.LeanbackActivity;
import com.mydrakortv.beta.ui.Utils;
import com.mydrakortv.beta.ui.presenter.IconHeaderItemPresenter;
...
public class CustomHeadersFragment extends HeadersSupportFragment {
    ...
    private void setHeaderAdapter() {
        ...
        String[] headerItem = new String[]{"Home", "Movies", "TV Series", "Favorite", "My Account"};

        int[] headerIcon = new int[]{R.drawable.outline_home_24, R.drawable.outline_movie_24,
                R.drawable.outline_local_movies_24, R.drawable.ic_favorite_border_black_24dp,
