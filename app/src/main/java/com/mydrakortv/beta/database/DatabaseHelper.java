package com.mydrakortv.beta.database;
...
import com.mydrakortv.beta.model.AdsConfig;
import com.mydrakortv.beta.model.AppConfig;
import com.mydrakortv.beta.model.Configuration;
import com.mydrakortv.beta.model.PaymentConfig;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "com.mydrakortv.beta.db";
    ...
    public long insertUserData(Otp user) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
    ...
    public long updateUserData(Otp user, long id) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(USER_COLUMN_NAME, user.getName());
        contentValues.put(USER_COLUMN_EMAIL, user.getEmail());
